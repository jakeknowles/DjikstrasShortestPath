/**
 * Representation of a directed graph edge. (CHANGED / ADDED METHODS HERE!)
 * @author Jake Knowles
...
public class Edge {
	...
	/** Additional constructor to make a new edge.
	 * 
	 * @param e e is an edge.
	 */
	public Edge(Edge e) {
		// Constuctor helps allow creation of edge's to be broad
